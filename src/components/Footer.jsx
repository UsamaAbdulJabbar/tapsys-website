...
const Footer = () => (
  <section className={`${styles.flexCenter} flex-col  `}>
          ...
          <div key={footerlink.title} className={`flex flex-col ss:my-0 my-4 min-w-[150px]`}>
            ...
            <ul className="list-none mt-4">
              {footerlink.links.map((link, index) => (
                ...
                >
                  <Link to={link.link} target="blank">{link.name}</Link>
    ...
    <div className="w-full  flex justify-between items-center md:flex-row flex-col p-6 border-t-[1px] border-t-[#3F3E45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-[#007fcc]">
        Copyright Ⓒ 2025 Tapsys Services Pvt. Ltd. All Rights Reserved.
      </p>
